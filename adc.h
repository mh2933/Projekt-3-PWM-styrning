...
struct adc
{
	...
	uint16_t pwm_on_time_us;  /* On-tid för PWM-generering i mikrosekunder. */
	uint16_t pwm_off_time_us; /* Off-tid för PWM-generering i mikrosekunder. */
};
...
*                                        mikrosekunder.
                      - pwm_on_time_us:  Pekare till pwm generead on tid i 
					                     mikrosekunder 
					  - pwm_off_time_us: Pekare till pwm generead on tid i
									     mikrosekunder
********************************************************************************/
